...
{
    internal class KnifeLight : ModProjectile, IHollowKnightProjectile
    {
                        ...
                        for (j = 0; j <= height; j++)
                        {
                            if (Main.tile[x1 + i, y1 + j].HasTile && Main.tile[x1 + i, y1 + j].TileType == 48)
                            {
                                ...
                                for (float ra = -50; ra <= 50; ra += 0.5f)
                                {
                                    ...
                                    Dust dust = Dust.NewDustDirect(Projectile.Center + new Vector2(ra - 4f, 12f), 1, 1, DustID.SpectreStaff, 0f, 0f, 0, Color.White, size);
                                    dust.noGravity = true;
        ...
        /*public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture = ModContent.GetTexture("Candlight/Projectiles/刀光3");
